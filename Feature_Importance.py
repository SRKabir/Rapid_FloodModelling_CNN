...
#%%
##############################################################################
scriptsPath = '/home/cvssk/Carlisle_Resubmission/' # location of the Carlisle_Inun_Mod.py
sys.path.insert(0,scriptsPath)

os.chdir(scriptsPath)

from InunMod_v1 import data_pre_process, CNN_Model
...
df = pd.read_csv('/home/cvssk/Carlisle_Resubmission/2005Event/Flows/Train/appended.csv')
print(df.head())
df = df.iloc[:,1:]
print(df.head())
...
rnk.to_csv('/home/cvssk/Carlisle_Resubmission/2005Event/CNN_Validation/Feature_Rank.csv')
